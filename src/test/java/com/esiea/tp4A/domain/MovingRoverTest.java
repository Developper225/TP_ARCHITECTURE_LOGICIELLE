...
class MovingRoverTest {
    ...
    void notMoving() throws Exception {
        MarsRover marsRover = new MovingRover(position, laserRange, planetMap).initPos(Position.of(0,0,Direction.NORTH));
    ...
    void TurningRightRoverFromWestDirection() throws Exception {
        MarsRover marsRover = new MovingRover(position, laserRange, planetMap).initPos(Position.of(0,0,Direction.WEST));
        Position newPosition = marsRover.move("r");
        Assertions.assertThat(newPosition).isEqualTo(Position.of(0, 0, Direction.NORTH));
    }
    ...
    void TurningLeftRoverFromEastDirection() throws Exception {
        MarsRover marsRover = new MovingRover(position, laserRange, planetMap).initPos(Position.of(0,0,Direction.EAST));
        Position newPosition = marsRover.move("l");
        Assertions.assertThat(newPosition).isEqualTo(Position.of(0, 0, Direction.NORTH));
    }
    ...
    void complexMovesFromDifferentOrigin() throws Exception {
        MarsRover marsRover = new MovingRover(position, laserRange, planetMap).initPos(Position.of(4,5,Direction.WEST));
    ...
    void MovingRoverOnSphericalMap() throws Exception {
        MarsRover marsRover = new MovingRover(position, laserRange, planetMap).initPos(Position.of(0,50,Direction.NORTH));
        Position newPosition = marsRover.move("f");
    ...
    void MovingRoverOnSphericalMapWithObstacles() throws Exception{
        ...
        MarsRover newMarsRover = marsRover.reviseMap(planetMap);
    ...
    void MovingRoverWithObstaclesAndShootingWithLaserRangeEqualsTo2() throws Exception{
        ...
        MarsRover updateMarsRover = marsRover.reviseMap(planetMap);
        MarsRover newsMarsRover1 = updateMarsRover.setLaserConf(2);
